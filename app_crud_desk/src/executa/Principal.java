...
public class Principal {
	...
	public static void main(String[] args) throws SQLException {
		...
		Object valor = JOptionPane.showInputDialog
				(null, "Escolha uma opção", "Opção", JOptionPane.INFORMATION_MESSAGE,
				null, itens, itens[3]);
		...
		if (valor.equals("Cadastrar")) { // Cadastrar
				...
				int a = JOptionPane.showConfirmDialog
						(null, "Voce tem certeza que deseja alterar esse Registro ???");
					if (a == 0) {
				...
				u.id = Long.parseLong(id);// Convert String p Int
				int a = JOptionPane.showConfirmDialog(null, "Voce tem certeza que deseja excluir esse Registro ???");
				if (a == 0) {

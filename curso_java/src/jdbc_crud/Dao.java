...
public class Dao {
	...
	public void getLista() throws SQLException {
		...
		String sql = "SELECT * FROM DB_JAVA.USUARIOS";
	...
	public void inserir(Usuario u) throws SQLException {
		...
		String sql = "INSERT INTO DB_JAVA.USUARIOS (NOME, EMAIL, TELEFONE) " 
		+ "values (?,?,?)";
		// Prepare p insert
		PreparedStatement pst = conn.prepareStatement(sql);
		// Seta Valores
	...
	public void inserirId(Usuario u) throws SQLException {
		...
		String sql = "INSERT INTO DB_JAVA.USUARIOS (ID,NOME, EMAIL, TELEFONE) " + "values (?,?,?,?)";
		// Prepare p insert
		PreparedStatement pst = conn.prepareStatement(sql);
		// Seta Valores
		pst.setLong(1, u.id);
	...
	public void alterar(Usuario u) throws SQLException {
		String sql = "UPDATE DB_JAVA.USUARIOS SET NOME=?, EMAIL=?, TELEFONE=?"
				+ "WHERE ID = ?";
		PreparedStatement pst = conn.prepareStatement(sql);
		pst.setString(1, u.nome);
		pst.setString(2, u.email);
	...
	public void deletar(Usuario u) throws SQLException {
		String sql = "DELETE FROM DB_JAVA.USUARIOS WHERE ID = ?";
